...
# Comprehensive & Trending Security Guardrails Filter
def keyword_spam_filter(text):
    text_lower = text.lower()
    
    # Aj kal ke trending scams, job traps, aur financial frauds ke keywords
    scam_keywords = [
        # Fake Work From Home & Job Traps
        'work from home', 'earn online', 'earn from home', 'housewife student', 
        'earn at your own pace', 'no prior experience required', 'part-time income', 
        'full-time online career', 'message now to get started', 'online work opportunities', 
        'daily income', 'earning safely and professionally', 'clicking ads', 'liking youtube videos',
        
        # Banking & Financial Info
        'pin', 'cnic', 'atm card', 'bank account', 'password', 'otp', 
        'jazzcash', 'easypaisa', 'crypto wallet', 'credit card', 'debit card',
        
        # Utility & Service Disconnections
        'electricity meter', 'power disconnection', 'gas connection', 
        'disconnected tonight', 'unpaid dues', 'bill overdue', 'water supply',
        'sim card blocked', 'connection terminated', 'service suspended',
        
        # Urgency & Pressure Tactics
        'urgent notice', 'final alert', 'call immediately', 'verify your details',
        'unblock', 'account locked', 'suspicious activity', 'legal action',
        
        # Prizes, Lotteries & Money Scams
        'crore', 'lottery', 'prize', 'winner', 'mega lucky draw', 
        'free gift card', 'cash reward', 'double your money', 'inheritance',
        
        # Investments & Quick Rich Schemes
        'guaranteed profit', 'investment scheme', 'double your money in', 
        'join our whatsapp group now', 'commissioner agent'
    ]
...
# Page Setup
st.set_page_config(
    page_title="AI Email Spam Detector V3.1",
    page_icon="🛡",
    layout="wide",
...
with col_logo:
    st.markdown("<h3 style='margin:0; font-size:17px; color:#ffffff; padding-top:6px;'>❖ AI Spam Detector <span style='font-size:10px; background:#11382c; padding:2px 6px; border-radius:4px; color:#34d399;'>V3.1</span></h3>", unsafe_allow_html=True)
...
if st.session_state.page == "Dashboard":
    ...
    st.markdown("<p style='color: #64748b; font-size: 12px; margin-top: 2px;'>Paste any email or message to check spam patterns securely.</p>", unsafe_allow_html=True)
    ...
    with col2:
        if analyze_clicked:
            if not st.session_state.input_text.strip():
                ...
                is_scam_keyword = keyword_spam_filter(st.session_state.input_text)
                    ...
                    <div class='custom-card'>
                        ...
                        <div class='spam-main-banner'>
                            <div>
                                ...
                                <span style='font-size:10px; color:#fca5a5;'>Fake job trap or threat pattern recognized</span>
                            </div>
                        ...
                        <div class='rec-spam-box'>
                            ...
                            <p style='font-size:11px; margin:0; color:#fca5a5;'>Do not trust unverified online jobs or share personal details. Delete immediately.</p>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
                else:
                    ...
                    <div class='custom-card'>
                        ...
                        <div class='safe-main-banner'>
                            <div>
                                ...
                                <span style='font-size:10px; color:#6ee7b7;'>No threat patterns found</span>
                            </div>
                            <div style='text-align: right;'>
                        ...
                        <div class='rec-safe-box'>
                            <p style='font-size:11px; font-weight:700; margin:0 0 2px 0;'>🕒 RECOMMENDATION</p>
                            <p style='font-size:11px; margin:0; color:#6ee7b7;'>This message appears completely safe and legitimate.</p>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
        else:
...
# --- SETTINGS PAGE ---
    ...
    st.write("Active Model: **Trained Classifier + Trending Job & Phishing Guardrails**")
    st.write("Status: **Synchronized & Secured**")
    st.markdown("</div>", unsafe_allow_html=True)
