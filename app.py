...
# Page Config (Yeh bilkul sabse pehli command honi chahiye)
...
# Footer
st.markdown("<div style='text-align:center; color:#334155; font-size:11px; margin-top:20px;'>Streamlit • TensorFlow • Running live</div>", unsafe_allow_html=True)